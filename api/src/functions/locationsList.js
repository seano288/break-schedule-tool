...
import { renderLocationsPage } from '../lib/locationView.js';

export async function locationsListHandler(request) {
    ...
    return {
        ...
        body: renderLocationsPage({ role: link.role, locations })
    };
}

app.http('locationsList', {
    methods: ['GET'],
    authLevel: 'anonymous',
    route: 'locations',
